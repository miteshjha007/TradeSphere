...
const routes: Routes = [
  { path: 'auth', loadChildren: () => import('./modules/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      { path: 'crypto-options', loadChildren: () => import('./modules/crypto-options/crypto-options.module').then(m => m.CryptoOptionsModule) },
      {
        path: 'indian-market',
        children: [
          ...
          { path: 'stock-analyzer', loadChildren: () => import('./modules/stock-picks/stock-picks.module').then(m => m.StockPicksModule) },
